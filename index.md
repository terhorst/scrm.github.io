...
* __Mac__: scrm is available via the [Homebrew package manager](https://brew.sh). After installing Homebrew, run `brew install homebrew/science/scrm` to build the latest version of scrm.
